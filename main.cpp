//All rights reserved by MD. Muhaiminul isla
#include<windows.h>
#include <GL/glut.h>
#include<bits/stdc++.h>
#include <stdlib.h>
...
static void display(void)
{
    ...
    if(START){
        ...
        drawStrokeText("First click the screen with mouse and then press G to Start",-1,-1,0);
        drawStrokeText2("Dodge game",-2,0,0);
    }
...
static void display2(void)
{
    ...
    if(START){
        ...
        drawStrokeText("First click the screen with mouse and then press G to Start",-1,-1,0);
        drawStrokeText2("Dodge Game",-1,0,0);
    }
...
{
    int n;
    printf("                                 This project is developed by Md. Muhaiminul Islam. ID: 163-15-8473                       \n\n\n");
    printf("---------------------------------------------Dodge game------------------------------------------\n\n");
    printf("There are two avatar you can play with: 1. Plane    2:Ball \n\n");

    printf("Enter the avatar. Tap 1 for plane and tap 2 for ball =  ");
    scanf("%d",&n);
    glutInit(&argc, argv);
